...
public class Form_Usuarios extends javax.swing.JPanel {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        CargarUsuario pantallaVenta = new CargarUsuario();
        pantallaVenta.setFormUsuariosReference(this);
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if(table.getRowCount() > 0){
            if(table.getSelectedRow() != -1){
                int num_usuario= Integer.parseInt (String.valueOf(table.getValueAt(table.getSelectedRow(), 0)));

                ModificarUsuario pantallaModif = new ModificarUsuario(num_usuario);
                pantallaModif.setFormUsuariosReference(this);
                pantallaModif.setVisible(true);
                pantallaModif.setLocationRelativeTo(null);

            }
            else{
                MostrarMensaje.mostrarMensaje("No se seleccionó ningun usuario", "Error", "Error al editar");
            }
        }
        else{
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        if(table.getRowCount() > 0){
            if(table.getSelectedRow() != -1){
                ...
                MostrarMensaje.mostrarMensaje("Usuario eliminado con exito", "Info", "Borrado de usuario");
                cargarDatos();
            }
            else{
                MostrarMensaje.mostrarMensaje("No se seleccionó ningun usuario", "Error", "Error al eliminar");
            }
        }
        else{
