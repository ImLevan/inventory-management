...
public class CargarVenta extends javax.swing.JFrame {
    ...
    public CargarVenta(Usuario usuario) {
    ...
    private void initComponents() {
        ...
        if (prodTable.getColumnModel().getColumnCount() > 0) {
            prodTable.getColumnModel().getColumn(5).setHeaderValue("Precio");
        }
    ...
    private void btnPagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPagarActionPerformed
        ...
        if (cuentaTable.getRowCount() > 0) {
            ...
            control.guardarVenta(usuario, montoTotal, existenciasCantidad);
    ...
    private void habilitarBotonSiCamposLlenos() {
        boolean camposLlenos = !txtPrecio.getText().isEmpty() && !txtCantidad.getText().isEmpty();
        btnAgrCuenta.setEnabled(camposLlenos);
    }
